...
public class Test19 {
    ...
    public String m1(HttpServletResponse response) throws Exception{
        ...
        //쿠키는 문자만 가능!
        response.addCookie(new Cookie("name", URLEncoder.encode("hong홍", "UTF-8")));
        // 쿠키에 ASCII 코드가 아닌 문자가 포함될 경우 보낼 수 없다. URL 인코딩 해서 보내라
    ...
    @ResponseBody
    // 해당 이름의 쿠키가 업으면 예외가 발생한다.
    //Missing cookie 'name' for method parameter of type Cookie
