...
public class Test12 {
    ...
    public String m5() {
        System.out.println(sc);
        return "ex02.Text12.m5()";
    }  
    
    // JSP 에 넘겨줄 데이터를 담을 수 있는 보관소를 받을 수 있다.
    @RequestMapping("m6")
    public String m6(Map<String,Object> map) {
        map.put("name","홍길동");
        map.put("age", 20);
        
        // Map 객체에 저장한 데이터는 프론트 컨트롤러가 ServletRequest 보관소로 옮긴다.
