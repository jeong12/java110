...
public class Test02 {
    ...
    public static void test2() {
        ...
        // 이 방식의 문제는, 대소문자를 구분하지 않는 맵을 사용하려면, 
        // 위와 같은 식으로 get(), put() 할 떄 마다
        // key에 대해 toLowerCase()를 매번 호출해야 한다는 불편함이 있다.

    }


    // key에 대해 대소문자를 구분하지 않게 하게 Map을 만드는 두 번째 방법:
    // => 기존 클래스를 상속 받아 기능을 변경하기
    public static void test3() {

        class MyHashMap extends HashMap<String, Object>{
            // get()과 put()의 기능을 오버라이딩 하다.
        ...
        /* 삭속으로 기능을 변경하는 방식의 문제점?
         * => 다른 클래스(예:HashTable)에도 적용하고 싶다면, 또 그 클래스를 상속 받아 만들어야 한다.
         * 
         */
