...
public class Servlet01 extends GenericServlet{
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        // 테스트
        // => http://localhost:8888/ex04/get.html 페이지에서 값을 입력 후 보내기
 ...
 *  ex)GET /ex04/servlet01?name=%ED%99%8D%EA%B8%B8%EB%8F%99&age=20&working=true HTTP/1.1
 * 
 *  
 */
/*
 ...
 * - 바이너리 데이터 전송
 *  => request-URI에 포함할 수 있는 것은 텍스트이기 때문에, 바이너리 데이터(이미지, 엑셀, 영상 등)를 전송하는 데 
 *     적합하지 않다. 
 *  => base64 인코딩을 이용하여 바이너리 데이터를 텍스트로 변환한 다음에 보낼 수는 있다.
 *  => 하지만 결국 대용량의 데이터인 경우에는 마찬가지로 크기 제한 떄문에 불가능하다. 
 * - 적용 부분
