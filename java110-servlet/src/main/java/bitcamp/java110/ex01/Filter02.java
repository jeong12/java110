...
public class Filter02 implements Filter{
    ...
    public void doFilter(ServletRequest request, 
        ...
        // 서블릿을 실행하기 전에 하는 일: 
        // - 클라이언트가 암호화 해서 보낸 데이터를 서블릿이 사용할 수 있도록 암호 해제 하기
        // - 클라이언트가 압축해서 보낸 데이터를 서블릿이 사용할 수 있도록 압출 해제 하기
        ...
        // 따라서 빼면 안된다!
        // 최종적으로 서블릿의 service()의 호출이 끝나면 위 메서드는 리턴된다.
    ...
    @Override
    public void destroy() {
        // 톰캣 서버가 종료되거나 웹 애플리케이션이 멈출 때, 생성된 모든 필터에 대해 이 메서드를 호출한다.
        // 
